...
<div class="container mx-auto p-4">
    ...
    <form action="/search" method="GET" class="mb-4">
        <input type="text" name="query" placeholder="Search by name, category, or location" class="border p-2 rounded w-1/2">
        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">Search</button>
    </form> --}}
    {{-- --------------------- --}}
    ...
    <div class="flex flex-wrap mt-4">
        @foreach($products as $product)
            <div class="border border-blue-300 shadow-lg p-4 m-2 w-1/4 rounded-lg">
                ...
                <img src="{{ asset('storage/' . $product->image) }}" alt="Product Image" class="w-90 h-32 object-cover mb-2">
                @else
                <div class="w-90 h-32 bg-gray-200 mb-2"></div>
                @endif --}}
                {{-- ---------------- --}}
